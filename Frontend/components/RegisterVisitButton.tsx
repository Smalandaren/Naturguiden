  ...
  async function HandleClick() {
    if (isVisited == false && user != null) {
      try {
        ...
        if (response.ok) {
          setIsVisited(true);
          toast.success("Platsen har markerats som besökt");
        }
        ...
        toast.error("Platsen kunde inte markeras som besökt");
        console.log(error);
      }
      ...
      try {
        ...
        if (response.ok) {
          setIsVisited(false);
          toast.success("Platsen har avmarkerats som besökt");
        }
        ...
        toast.error("Platsen kunde inte avmarkeras som besökt");
        console.log(error);
      }
    }
  }
