...
export default function Map({ place }: { place: Place }){
    return <div>
        <MapContainer center={[place.latitude, place.longitude]} zoom={10} scrollWheelZoom={true} className="h-100 w-full justify-self-center px-10 m-0 z-0 rounded-xl border">
            <TileLayer
